...
<table>
<tr>
<td valign="top"><img src="./nilanjana-ascii.svg" width="370" alt="ASCII portrait" /></td>
...
const nilanjana = {
  ...
  ⚡ motto:
    "Turning logic into interactive systems, one commit at a time."
};
```
...
const developerBrain = {
  ...
  creativity: "Building Web Applications",
  architectureThinking: "System Design",
  curiosity: "Learning New Technologies",
  debuggingSkill: "Turning Bugs Into Lessons"
};
```
...
<img src="https://github-readme-streak-stats.herokuapp.com/?user=nilanjanajui&theme=dracula&hide_border=true"/>
