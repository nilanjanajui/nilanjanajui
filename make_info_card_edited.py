...
# ===========================================================================
HOST = "nilanjana"   # shown as  nilanjana@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "CSE Student @ Univ. of Chittagong"),
    ("kv", "Role", "MERN Stack / Frontend Developer"),
    ("kv", "Edu", "B.Sc. CSE, expected 2027"),
    ("kv", "Origin", "Photography -> UI/UX -> Full Stack"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, Tailwind CSS"),
    ("kv", "Backend", "Node.js, Express, Django/DRF"),
    ("kv", "Database", "MongoDB, MySQL, Oracle"),
    ("kv", "Other", "TypeScript, C++, Python, Java"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "UrbanNest -- full-stack rental marketplace"),
    ("bul", "DriveFleet -- car rental platform, deployed"),
    ("bul", "SunCart -- eCommerce, hand-built CSS"),
]
